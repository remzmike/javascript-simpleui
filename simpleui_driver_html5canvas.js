...
function set_size() {
    // todo: begin/end_panel() inside which is all the stuff... that's probably the right way?... seems scary, ouch my heart
...
function DrawBox_Cached(x, y, width, height, color) {
    ...
    // original is 2ms, cached is 6-7, lets find out which rects are causing this?
